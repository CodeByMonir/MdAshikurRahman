...
export default function Achievements() {
    ...
    return (
        ...
        >
            ...
            >
                {/* 1. Geometric Quantum Hexagon / Honeycomb Matrix */}
                <div
              ...
              linear-gradient(to bottom, rgba(56, 189, 248, 0.15) 1px, transparent 1px)`,
                ...
                {/* 2. Celestial Award Halo & Constellation SVG */}
                <svg
                ...
                >
                    ...
                    {/* Radiating Milestone Vector Rays */}
                ...
                {/* 4. Deep Indigo / Emerald Base Glows */}
                <div
            ...
            <div className="relative z-10 max-w-6xl mx-auto flex flex-col space-y-16">
                ...
                <div className="text-center max-w-3xl mx-auto space-y-3.5">
                    ...
                    <p className="text-xs sm:text-sm text-[#334155] dark:text-[#94A3B8] leading-relaxed">
                        A comprehensive catalog of academic degrees, research breakthroughs supervised by
                        renowned researchers, Master Trainer appointments, and 1st-place distinction awards.
                    </p>
                </div>

                {/* ================= SECTION 1: TRAINING & HONORS (1ST PLACE CARD HIGHLIGHTED) ================= */}
                ...
                {/* ================= SECTION 2: ACADEMIC RESEARCH & PROJECTS ================= */}
                <div className="space-y-6">
                    <div className="flex items-center gap-2.5 pb-2 border-b border-[#E2E8F0] dark:border-[rgba(56,189,248,0.12)]">
                ...
                {/* ================= SECTION 3: ACADEMIC BACKGROUND & GPAS ================= */}
                <div className="space-y-6">
                    <div className="flex items-center gap-2.5 pb-2 border-b border-[#E2E8F0] dark:border-[rgba(56,189,248,0.12)]">
